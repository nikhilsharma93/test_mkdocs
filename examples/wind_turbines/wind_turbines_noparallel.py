"""Example showing the wind turbines model deployment in no-parallel mode.
...
def main_func(keys, model_path):
    ...
    c0_raster = Component(name='get_raster', func=get_raster)
    ...
    c1_preprocess = Component(name='preprocessing', func=preprocess)
    ...
    c4_postprocess = Component(name='postprocess', func=postprocess)
    ...
    c5_uploader = Component(name='upload', func=uploader)
